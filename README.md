...
| `brodgar-ui` | The minimap in a bare panel you drag and size anywhere, the chat as a window with a tab per channel, Ctrl+Space to find any action by name and run it, and an action bar for every page of the belt | — |
